...
**Installation**
- **Option 1**: Place the add-on folder into your Anki `addons21` directory, then restart Anki to load the add-on. (this is the only viable option until I load it to Anki)
...
- **Browser Options**: The **Capitalize Fields...** option in the Browser's Edit menu.  
  ![Browser Options](docs/screenshots/browser_options.png)  

- **Field Selection Dialog**: The window where you select fields and capitalization modes.  
  ![Field Selection Dialog](docs/screenshots/settings_windows.png)  
